        ...
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
            ...
            <div>
                ...
                <p class="text-slate-500 mt-2">
                    Daftarkan pegawai baru dan tentukan hak aksesnya pada sistem Jayusman Mart.
                </p>
        ...
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <h2 class="text-2xl font-bold">
                    Data Pegawai Jayusman Mart
                </h2>

                <p class="text-slate-300 text-sm mt-1">
                    Lengkapi informasi akun sebelum menyimpan data.
                </p>
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden max-w-5xl">
        ...
        <div class="px-6 py-5 border-b border-slate-100">
            ...
            <p class="text-sm text-slate-500 mt-1">
                Masukkan data akun yang akan digunakan pegawai untuk mengakses sistem.
            </p>
                ...
                <div>
                    ...
                    @if(auth()->user()->role === 'owner')
                        ...
                        <p class="text-xs text-slate-500 mt-2">
                            Kosongkan jika akun yang dibuat adalah Owner.
                        </p>
